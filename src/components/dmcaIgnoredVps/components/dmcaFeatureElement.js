      ...
      <div className="container">
        ...
        <div className="row align-items-center mb-5">
          ...
          <div className="col-md-6 privacyHardware-desc">
            <h2>
            Your Privacy is Our Priority!</h2>
            <p className="">
            We Understand the value of your privacy and fundamental rights that’s why we enable you to make your online presence with untraceable 
            footprints and impenetrable security.  In addition, we provide you services based on offshore servers that let you be anonymous on the 
            internet and guard your data against being tracked.  So what are you waiting for? Get your offshore hosting today and protect your data 
            privacy with industry-standard security! 
            </p>
