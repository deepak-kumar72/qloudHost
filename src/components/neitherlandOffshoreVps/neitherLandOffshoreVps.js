...
const faqsData = [
  {
    ...
    answer: `Yes, you can host multiple websites within one Amsterdam, Netherlands VPS hosting plan from QloudHost. Our Netherlands offshore Virtual Private hosting plans are designed to provide
      ...
      You can use the provided control panel to manage your websites, create multiple domains and subdomains, and install popular content management systems like <a href="https://qloudhost.com/offshore-wordpress-hosting/" class="faq-link">WordPress</a>, Joomla, or Drupal.
  ...
  },
  {
    ...
    answer: `QloudHost offers a 14-day money-back guarantee for their Netherlands VPS hosting services. This means that if you are not satisfied with their service for any reason within the first 30 days of signing up, you can request a full refund of your hosting fees.<br/>
      The money-back guarantee ensures that you can try out their hosting services risk-free and with complete peace of mind. If you encounter any issues or are not satisfied with their service, you can contact their <a href="https://my.qloudhost.com/submitticket.php?step=2&deptid=2" class="faq-link">support team</a> to initiate the refund process.`
  },
  {
