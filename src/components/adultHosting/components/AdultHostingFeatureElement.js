    ...
    <div className="container">
      ...
      <div className="row align-items-center mb-3">
        <div className="col-md-6 mb-4 text-center">
          <img src='/assets/feature/easy-upgrades.webp' alt="Easy Upgrade" className="img-fluid m-auto" />
        </div>
      ...
      <div className="row align-items-center mb-3">
        <div className="col-md-6 order-md-2 mb-3 text-center">
          <img src='/assets/feature/full-data-privacy.webp' alt="Data Privacy" className="img-fluid" />
        </div>
      ...
      <div className="row align-items-center mb-3">
        <div className="col-md-6 mb-4 text-center">
          <img src='/assets/feature/high-performance-dult-hosting_99-uptime.webp' alt="High Performance Adult Hosting" className="img-fluid m-auto" />
        </div>
        <div className="col-md-6 feature-element-sec">
