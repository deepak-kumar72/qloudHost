...
const plansData = [
  ...
  },
  {
    ...
    save: "SAVE 14%",
    features: ['6 CPU', '12 GB RAM', '2 GB NVMe SSD', '2 TB Bandwidth', 'Free Control Panel', 'Hosted in Netherlands'],
...
const OffshoreVpsPlan = () => {
  ...
  return (
    ...
    <div className="container plan-sec mt-5">
      ...
      <div className="row offshoreVps-plan justify-content-center" id='explorePlan'>
        {plansData.map((plan) => (
