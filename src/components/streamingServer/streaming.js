...
const faqsData = [
  {
    ...
    answer: `Offshore streaming servers are especially optimized servers that are used to perform bufferless online video or game streaming on the video platforms such as <a href="https://discord.com/" class="faq-link">Discord</a>, YouTube, 
  ...
  },
  {
    ...
    answer: `Offshore streaming servers work pretty much similar to regular servers but one aspect that creates the difference is that in streaming servers, 
      audio and <a href="https://qloudhost.com/offshore-video-hosting/" class="faq-link">videos</a> are broken into smaller data packets that are shared the same as the files are shared from the server to the client.`
  },
  {
    question: "How Long Does It Take for Offshore Streaming Server Setup?",
    answer: `Once you finish the payment, <a href="https://qloudhost.com/contact" class="faq-link">our team of technical experts</a> will immediately start working on your servers to complete the setup as soon as possible,
  ...
  },
  {
    ...
    answer: `Yes…..! Along with our normal <a href="https://qloudhost.com/offshore-hosting/" class="faq-link">offshore hosting plans</a>, we also offer you upgraded plans that comes with more powerful resources and features. 
      You can anytime shift to our upgraded plans without any complex formalities.  `
  },
  {
    question: "What Payment Methods Do You Accept?",
    answer: `We use multiple payment methods such as PayPal, debit card, credit card, <a href="https://g.co/kgs/g41cnt" class="faq-link">UPI</a> and much more to ensure that you can easily avail our services 
